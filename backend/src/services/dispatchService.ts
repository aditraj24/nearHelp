...
import { User, type IUserSkill } from '../models/user.model.js';
import { getNearbyUsers } from './locationService.js';
import type { CrisisType, SkillType } from '../constant.js';
...
const SKILL_CRISIS_MAP: Record<CrisisType, SkillType[]> = {
...
export const findBestResponders = async (
  longitude: number,
  latitude: number,
  crisisType: CrisisType,
  radiusMeters = 1000,
  batchSize = 10
): Promise<ScoredResponder[]> => {
