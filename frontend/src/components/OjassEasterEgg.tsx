...
interface OjassEasterEggHook {
  handleLogoClick: () => void;
  showVideo: boolean;
  setShowVideo: Dispatch<SetStateAction<boolean>>;
}

export function useOjassEasterEgg(requiredClicks = 5, timeout = 2000): OjassEasterEggHook {
 ...
 */
export default function OjassEasterEgg({ show, onClose }: OjassEasterEggProps) {
